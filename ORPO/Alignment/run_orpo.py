...
if __name__ == "__main__":
    ...
    import json
    f = open("./ORPO/Alignment/training_configs/" + script_args.training_config,'r')
    ...
    script_args.output_dir = "./ORPO/Alignment/saves/" +  script_args.training_config.removesuffix(".json")
